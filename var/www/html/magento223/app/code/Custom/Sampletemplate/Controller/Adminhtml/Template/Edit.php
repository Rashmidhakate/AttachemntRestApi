...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Custom\Sampletemplate\Model\Template $attachModel
    ) {
    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            $this->coreRegistry->register('template_id', $model->getId());
        }
        ...
        $this->coreRegistry->register('sampletemplate', $model);

        // 5. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->addBreadcrumb(
            $id ? __('Edit SampleTemplate') : __('New SampleTemplate'),
            $id ? __('Edit SampleTemplate') : __('New SampleTemplate')
        );
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getName() : __('New SampleTemplate'));
        return $resultPage;
    }
}
