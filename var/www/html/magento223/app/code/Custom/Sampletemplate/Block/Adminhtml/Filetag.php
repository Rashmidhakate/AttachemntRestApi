 ...
 */
class Filetag extends \Magento\Backend\Block\Widget\Grid\Container
{
    /**
     * Constructor
     *
    ...
    public function _construct()
    {
        ...
        $this->_headerText = __('FileTag ');
        $this->_addButtonLabel = __('Add New FileTag');
        parent::_construct();
        if ($this->_isAllowedAction('Custom_Sampletemplate::save')) {
            $this->buttonList->update('add', 'label', __('Add New FileTag'));
        } else {
